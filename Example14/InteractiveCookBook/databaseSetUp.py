...
cur.execute(f'''CREATE TABLE recipeBase({headers[0]} TEXT primary key, {headers[1]},{headers[2]} INTEGER );''')
cur.executemany(f'''INSERT INTO recipeBase({headers[0]},{headers[1]},{headers[2]}) VALUES(?,?,?);''', values)
